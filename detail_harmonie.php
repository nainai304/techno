...
<body>
  ...
  <section class="page-title-section">
    <h1 class="page-title">Harmonie Package</h1>
    <p class="page-subtitle">Paket dasar dengan konsep simple, rapi, dan seimbang — cocok untuk intimate wedding</p>
  </section>
  ...
  <main class="container">
    ...
    <section class="package">
      ...
      <p class="desc">Paket dasar dengan konsep simple, rapi, dan seimbang — cocok untuk intimate wedding yang penuh kehangatan.</p>
      <div class="price">💰 Range Harga: Rp 12.000.000 – Rp 18.000.000</div>

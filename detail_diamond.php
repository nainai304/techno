...
<head>
  ...
  <title>Diamond Package - Eternelle Wedding</title>
...
<body>
  ...
  <section class="page-title-section">
    <h1 class="page-title">Diamond Package</h1>
    <p class="page-subtitle">Paket luxury dengan dekorasi total, dokumentasi lengkap, dan layanan eksklusif</p>
  </section>

  <!-- Main Content -->
  <main class="container">
    <div class="gallery">
      <img src="diamond/1.jpg" alt="Dekorasi Diamond">
      <img src="diamond/2.jpg" alt="Lighting Diamond">
      <img src="diamond/3.jpg" alt="Backdrop Diamond">
    </div>

    <section class="package">
      <h2>💎 Diamond Package</h2>
      <p class="desc">Paket luxury dengan dekorasi total, dokumentasi lengkap, dan layanan eksklusif untuk pernikahan impian Anda.</p>
      <div class="price">💰 Range Harga: Rp 60.000.000 – Rp 90.000.000</div>

      <h3>Termasuk:</h3>
      <ul>
        <li>Full premium decoration (stage + aisle + ceiling + table styling)</li>
        <li>Instalasi crystal / mirror / luxury floral</li>
        <li>Full lighting show + LED / projection mapping</li>
        <li>Photo booth + lounge area tamu</li>
        <li>Dokumentasi full team (3 fotografer + 2 videografer + drone)</li>
        <li>WO VIP (10 crew + event director)</li>
        <li>Premium invitation (print + digital) 100 pax</li>
        <li>Souvenir curated set (optional)</li>
        <li>Food testing + full vendor handling</li>
      </ul>
      ...
      <div class="note">
        ...
        <ul>
          ...
          <li>Down payment 30% untuk konfirmasi booking.</li>
          <li>Konsultasi gratis untuk diskusi detail acara.</li>
        </ul>
      </div>

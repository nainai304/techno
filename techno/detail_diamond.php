...
<head>
  ...
  <style>
    body { font-family: 'Poppins', sans-serif; margin: 0; background: #fffdfd; color: #333; line-height: 1.6; }
...
<body>
  <header>
    ...
    <p>Detail Paket Pernikahan – Diamond Package</p>
  </header>
  ...
  <main class="container">
    ...
    <section class="package">
      ...
      <p class="desc">Paket luxury dengan dekorasi total, dokumentasi lengkap, dan layanan eksklusif.</p>
      <p class="price">💰 Range Harga: Rp 60.000.000 – Rp 90.000.000</p>

...
<head>
  ...
  <title>Lumière Package - Eternelle Wedding</title>
  <style>
    body {
...
<body>
  <header>
    ...
    <p>Detail Paket Pernikahan – Lumière Package</p>
  </header>

  <main class="container">
    <div class="gallery">
      <img src="lumiere/1.jpg" alt="Dekorasi Lumière">
      <img src="lumiere/2.jpg" alt="Lighting Lumière">
      <img src="lumiere/3.jpg" alt="Backdrop Lumière">
    </div>

    <section class="package">
      <h2>✨ Lumière Package</h2>
      <p class="desc">Paket menengah dengan tampilan dekor yang lebih detail & ambience lighting estetik.</p>
      <p class="price">💰 Range Harga: Rp 20.000.000 – Rp 30.000.000</p>

      <h3>Termasuk:</h3>
      <ul>
        <li>Dekorasi pelaminan medium (elegant + detail)</li>
        <li>Instalasi lighting ambience (fairy light / warm tone)</li>
        <li>Aisle dekor + flower vase minimalis</li>
        <li>Photo corner / mini backdrop tamu</li>
        <li>Foto + video dokumentasi 6 jam</li>
        <li>MC + Wedding Organizer (4 crew)</li>
        <li>Konsultasi langsung + free moodboard desain</li>
      </ul>

      <div class="note">
        <h3>🔖 Catatan</h3>
        <ul>
          <li>Harga dapat disesuaikan berdasarkan kota, vendor, jenis bunga, venue, dan jumlah tamu.</li>
          <li>Paket dapat ditambah fitur add-on seperti: catering, entertainment, live band, souvenir custom, dsb.</li>
        </ul>
      </div>

...
<head>
  ...
  <title>Lumiere Package - Eternelle Wedding</title>
...
<body>
  ...
  <section class="page-title-section">
    <h1 class="page-title">Lumiere Package</h1>
    <p class="page-subtitle">Paket menengah dengan tampilan dekor yang lebih detail & ambience lighting estetik</p>
  </section>
